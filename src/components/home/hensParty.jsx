...
const card_data = [
  {
    image:
      "https://cdn-blhad.nitrocdn.com/YjoyyGWRYAkynLQQCrAzLiCDRqOcqPAa/assets/images/optimized/rev-6f9d852/www.magicmen.com.au/wp-content/uploads/5J0A0400-768x512.jpg",
    title: "Dinner & Show",
  ...
  },
  {
    bg: "bg-gray-900",
    image:
      "https://cdn-blhad.nitrocdn.com/YjoyyGWRYAkynLQQCrAzLiCDRqOcqPAa/assets/images/optimized/rev-6f9d852/www.magicmen.com.au/wp-content/uploads/IMG_1295-768x512.jpg",
    title: "Drink & Show",
    desc: "Our most popular party favourite. Get our all-inclusive drinks and show package. Our best value for money package for any group size.",
    link: "https://www.magicmen.com.au/hens-party/#pkg3",
  },
  {
    image:
      "https://cdn-blhad.nitrocdn.com/YjoyyGWRYAkynLQQCrAzLiCDRqOcqPAa/assets/images/optimized/rev-6f9d852/www.magicmen.com.au/wp-content/uploads/limo-show-768x513.jpg",
    title: "Limo & Show",
    desc: "Our most popular party favourite. Get our all-inclusive drinks and show package. Our best value for money package for any group size.",
    link: "https://www.magicmen.com.au/hens-party/#pkg3",
  },
...
export default function HensPartyPkg() {
  return (
    <div className="bg-black min-h-full text-white mt-24 my-11 pb-11">
      <h1 className="text-center text-8xl font-alex-brush">
      ...
      <div className="mx-auto">
        <div className="flex md:w-4/5 w-full mx-auto justify-center items-stretch gap-4">
          {card_data.map((d, i) => {
