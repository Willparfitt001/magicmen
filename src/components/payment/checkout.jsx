...
//             Have a coupon? <span className="underline cursor-pointer">Click here to enter your code</span>
//           </p>
//           <div className="border-2 border-dashed border-gray-600 p-4 rounded">
//             <p className="text-sm mb-3">If you have a coupon code, please apply it below.</p>
...
//           <div>
//             <h2 className="text-2xl font-script mb-6" style={{ fontFamily: 'cursive' }}>Booking Details</h2>
...
//                 <span>Do you have event address?</span>
//                 <div className="flex items-center">
//                   <div
//                     className={`w-12 h-6 rounded-full cursor-pointer transition-colors ${formData.hasEventAddress ? 'bg-green-500' : 'bg-gray-600'}`}
//                     onClick={() => handleToggle('hasEventAddress')}
//                   >
//                     <div
//                       className={`w-5 h-5 bg-white rounded-full mt-0.5 transition-transform ${formData.hasEventAddress ? 'translate-x-6' : 'translate-x-0.5'}`}
//                     />
//                   </div>
//                   <span className="ml-2 text-sm">{formData.hasEventAddress ? 'Yes' : 'No'}</span>
//                 </div>
//               </div>
...
//               <div className="flex items-center justify-between">
//                 <span>Is above date and time confirmed?</span>
//                 <div className="flex items-center">
//                   <div
//                     className={`w-12 h-6 rounded-full cursor-pointer transition-colors ${formData.isDateTimeConfirmed ? 'bg-green-500' : 'bg-gray-600'}`}
//                     onClick={() => handleToggle('isDateTimeConfirmed')}
//                   >
//                     <div
//                       className={`w-5 h-5 bg-white rounded-full mt-0.5 transition-transform ${formData.isDateTimeConfirmed ? 'translate-x-6' : 'translate-x-0.5'}`}
//                     />
//                   </div>
//                   <span className="ml-2 text-sm">{formData.isDateTimeConfirmed ? 'Yes' : 'No'}</span>
//                 </div>
//               </div>
...
//           {/* Payment Section */}
//           <div>
//             <h2 className="text-2xl font-script mb-6" style={{ fontFamily: 'cursive' }}>Make A Reservation</h2>

//             <div className="bg-gray-800 p-6 rounded-lg space-y-6">
//               <div>
//                 <h3 className="text-lg font-script mb-4" style={{ fontFamily: 'cursive' }}>Pay my Deposit</h3>
...
//                 <div>
//                   <label className="block text-sm mb-2">Expiry (MM/YY) *</label>
//                   <input
//                     type="text"
//                     name="expiryDate"
...
//                 </div>
//                 <div>
//                   <label className="block text-sm mb-2">Card Code *</label>
//                   <input
//                     type="text"
//                     name="cardCode"
...
//                       formData.hasEventAddress ? 'bg-green-500' : 'bg-gray-600'
//                     }`}
//                     onClick={() => handleToggle('hasEventAddress')}>
//                     <div
