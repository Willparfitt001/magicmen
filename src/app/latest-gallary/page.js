  ...
  return (
    <div>
      ...
      <main className="bg-black pt-24">
        <div className="w-full p-4  space-y-6 text-center mx-auto text-white">
        ...
        {/* share icon */}
        <div className="text-white mt-11 w-full md:w-4/5   mx-auto flex flex-col justify-center items-center">
