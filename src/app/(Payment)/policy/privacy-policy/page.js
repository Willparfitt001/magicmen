export default function Page(){
    return <section className="space-y-6 pb-11 my-11 text-center md:px-36 sm:px-11 p-2">
        <h1 className="font-bold text-xl md:text-4xl capitalize">Who we are</h1>
        <b className="block">Magic Men Live Pty Ltd trading as Magic Men Australia is committed to providing quality services to you and this policy outlines our ongoing obligations to you in respect of how we manage your Personal Information.</b>
        ...
        <h1 className="font-bold text-xl md:text-4xl capitalize">What is Personal Information and why do we collect it?</h1>
  ...
  <p>When we collect Personal Information we will, where appropriate and where possible, explain to you why we are collecting the information and how we plan to use it.</p>  
        <h1 className="font-bold text-xl md:text-4xl capitalize">Sensitive Information</h1>
  ...
  <p>With your consent; or where required or authorised by law.</p>  
        <h1 className="font-bold text-xl md:text-4xl capitalize">Third Parties</h1>
  ...
  <p>Disclosure of Personal Information
Your Personal Information may be disclosed in a number of circumstances including the following:</p>  
  ...
  <p>Security of Personal Information
...
<p>Magic Men Australia will not charge any fee for your access request but may charge an administrative fee for providing a copy of your Personal Information.</p>
